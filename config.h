...
static const char dmenufont[]       = "SauceCodePro Nerd Font:size=9";       /* dmenu font */
static const char barendfont[]      = "SauceCodePro Nerd Font:pixelsize=14"; /* bar end character font */
static const char barendleft[]      = "";                                   /* left bar end character */
static const char barendright[]     = "";                                   /* right bar end character */
static const char *fonts[]          = { "SauceCodePro Nerd Font:pixelsize=12:antialias=true:autohint=true", "JoyPixels:pixelsize=10:antialias=true:autohint=true" };
...
const char *spcmd1[] = { "st", "-n", "spterm", "-g", "160x42", NULL };
...
static const Layout layouts[] = {
        /* symbol      arrange function             Comment */
...
static const char *dmenucmd[] = { "prettydmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
